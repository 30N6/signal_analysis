filename = "analysis-20250209-110744.log";
...
power_match     = ([scan_reports.mean_power_dB] > 25).';
timestamp_match = ([scan_reports.timestamp_sec] > 0).' & ([scan_reports.timestamp_sec] < 100).';
mod_match        = ([scan_reports.lora_r_squared] > 0.0).' & ([scan_reports.lora_peak_count_ratio] > 0).';
